...
public:
    ...
    void drawPixelXYF_Y(uint16_t x, float y, const CRGB &color, uint8_t darklevel=0);
    void drawPixelXYF_X(float x, uint16_t y, const CRGB &color, uint8_t darklevel=0);
