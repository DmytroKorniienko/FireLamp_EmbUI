...
static const char TEFF_005 [] PROGMEM = "Nevada";
static const char TEFF_006 [] PROGMEM = "Ventisca, Estrellas fugaces, Meteoritos";
static const char TEFF_007 [] PROGMEM = "Matriz";
...
static const char TEFF_039 [] PROGMEM = "Tormenta";
static const char TEFF_040 [] PROGMEM = "Lluvia fuera de la ventana ...";
...
static const char TEFF_064 [] PROGMEM = "Isla de la Serpiente";
...
static const char TEFF_069 [] PROGMEM = "Serpientes de Sottnik (test)";
...
static const char TINTF_003[] PROGMEM = "Presencia lista de Efectos";
static const char TINTF_004[] PROGMEM = "Presencia lista demo";
...
static const char TINTF_020[] PROGMEM = "Microfono";
static const char TINTF_021[] PROGMEM = "Microfono Activado";
...
static const char TINTF_025[] PROGMEM = "Calibrar microfono";
static const char TINTF_026[] PROGMEM = "Encende el microfono";
...
static const char TINTF_04F[] PROGMEM = "Periodo de visualización(0 - No visualizar)";
...
static const char TINTF_08B[] PROGMEM = "Restablecer la configuración de efectos";
static const char TINTF_08C[] PROGMEM = "Prefijo de Topic";
static const char TINTF_08D[] PROGMEM = "Ordenar por microfono";
...
static const char E_LLEND[] PROGMEM = "{\"nb\":@nb@,\"name\":\"@name@\",\"ver\":@ver@,\"flags\":255,\"ctrls\":[{\"id\":2,\"type\":0,\"val\":0,\"min\":0,\"max\":10,\"step\":1,\"name\":\"Efecto (0 = Cíclicamente)\"}, {\"id\":3,\"type\":0,\"val\":0,\"min\":0,\"max\":@pal@,\"step\":1,\"name\":\"Palitra\"}]}";
...
static const char E_LEAPERS_CFG[] PROGMEM = "{\"nb\":@nb@,\"name\":\"@name@\",\"ver\":@ver@,\"flags\":255,\"ctrls\":[{\"id\":3,\"type\":0,\"val\":1,\"min\":1,\"max\":50,\"step\":1,\"name\":\"Жогово!\"},{\"id\":7,\"type\":18,\"val\":\"true\",\"name\":\"Micrófono\"}]}";
...
static const char E_FREQ_CFG[] PROGMEM = "{\"nb\":@nb@,\"name\":\"@name@\",\"ver\":@ver@,\"flags\":255,\"ctrls\":[{\"id\":2,\"type\":0,\"val\":127,\"min\":1,\"max\":255,\"step\":1,\"name\":\"Ganancia\"}, {\"id\":3,\"type\":0,\"val\":1,\"min\":1,\"max\":@pal@,\"step\":1,\"name\":\"Palitra\"}]}";
...
static const char E_F2018_CFG[] PROGMEM = "{\"nb\":@nb@,\"name\":\"@name@\",\"ver\":@ver@,\"flags\":255,\"ctrls\":[{\"id\":2,\"type\":0,\"val\":1,\"min\":1,\"max\":255,\"step\":1,\"name\":\"Tono\"}, {\"id\":3,\"type\":2,\"val\":\"true\",\"name\":\"Линейная Velocidad\"}, {\"id\":7,\"type\":18,\"val\":\"true\",\"name\":\"Micrófono\"}]}";
...
static const char E_ATTRACT_CFG[] PROGMEM = "{\"nb\":@nb@,\"name\":\"@name@\",\"ver\":@ver@,\"flags\":255,\"ctrls\":[{\"id\":2,\"type\":0,\"val\":100,\"min\":1,\"max\":255,\"step\":1,\"name\":\"Энергия\"}, {\"id\":3,\"type\":0,\"val\":100,\"min\":1,\"max\":255,\"step\":1,\"name\":\"Peso\"}, {\"id\":4,\"type\":0,\"val\":1,\"min\":1,\"max\":@pal@,\"step\":1,\"name\":\"Palitra\"}]}";
...
static const char E_SNAKE2_CFG[] PROGMEM = "{\"nb\":@nb@,\"name\":\"@name@\",\"ver\":@ver@,\"flags\":255,\"ctrls\":[{\"id\":2,\"type\":0,\"val\":1,\"min\":1,\"max\":@pal@,\"step\":1,\"name\":\"Palitra\"}, {\"id\":3,\"type\":2,\"val\":\"false\",\"name\":\"Color Disco\"}, {\"id\":4,\"type\":2,\"val\":\"false\",\"name\":\"Subpixel\"}, {\"id\":7,\"type\":18,\"val\":\"true\",\"name\":\"Micrófono\"}]}";
...
static const char E_RAIN_CFG[] PROGMEM = "{\"nb\":@nb@,\"name\":\"@name@\",\"ver\":@ver@,\"flags\":255,\"ctrls\":[{\"id\":2,\"type\":0,\"val\":25,\"min\":1,\"max\":45,\"step\":1,\"name\":\"Dencidad\"}, {\"id\":3,\"type\":2,\"val\":\"true\",\"name\":\"Nuve\"}, {\"id\":4,\"type\":2,\"val\":\"true\",\"name\":\"Tormenta\"}]}";
...
static const char E_PALMICUI_CFG[] PROGMEM = "{\"nb\":@nb@,\"name\":\"@name@\",\"ver\":@ver@,\"flags\":255,\"ctrls\":[{\"id\":3,\"type\":0,\"val\":1,\"min\":0,\"max\":@pal@,\"step\":1,\"name\":\"Palitra (0 = без Colorа)\"},{\"id\":4,\"type\":2,\"val\":\"true\",\"name\":\"Suavizar\"},{\"id\":7,\"type\":18,\"val\":\"true\",\"name\":\"Micrófono\"}]}";
