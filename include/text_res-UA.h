...
static const char TINTF_052[] PROGMEM = "Правила TZSET обчислення поясного/сезонного часу (напр 'EET-2EEST,M3.5.0/3,M10.5.0/4' для Europe/Kyiv) потрібний рядок можна взяти тут https://github.com/esp8266/Arduino/blob/master/cores/esp8266/TZ.h";
