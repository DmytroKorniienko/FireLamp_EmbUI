...
- WiFi connection attempts will timeout after 10 seconds if a successful connection has not been established.  ```EMBUI_WIFI_CONNECT_TIMEOUT``` can be changed in ```E131.h```.
