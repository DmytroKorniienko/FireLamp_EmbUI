...
## За допомогою енкодера:
   ...
   - Щоб скинути системні налаштування лампи\панелі, натисніть енкодер, подайте на прилад живлення та утримуйте єнкодер натиснутим не менше 10-ти секунд. (Увага! Налаштування ефектів не скидується)
